...
public class BorrowingManagementIntegrationTests {
    ...
    public void testSendValidBorrowingRequest() {
        ...
        BorrowingRequestRequestDto request = new BorrowingRequestRequestDto(START_TIME, END_TIME, validSenderId,
                validGameCopyId);
        ResponseEntity<BorrowingRequestResponseDto> response = client.postForEntity("/borrowingRequests", request,
    ...
    public void testSendBorrowingRequestInvalidGameCopyTest() {
        BorrowingRequestRequestDto requestDto = new BorrowingRequestRequestDto(START_TIME, END_TIME, validSenderId,
                99999);
    ...
    public void testFindDeliveredRequestsForBorrowerValid() {
        ...
        BorrowingRequestRequestDto requestDto = new BorrowingRequestRequestDto(START_TIME, END_TIME, validSenderId,
                validGameCopyId);
        ResponseEntity<BorrowingRequestResponseDto> response = client.postForEntity("/borrowingRequests", requestDto,
                BorrowingRequestResponseDto.class);
        assertEquals(HttpStatus.CREATED, response.getStatusCode());
    ...
    void testUpdateBorrowingRequestThatDoesNotExist() {
        ...
        ResponseEntity<String> response = client.exchange(updateUrl, org.springframework.http.HttpMethod.PUT, null,
                String.class);
        assertEquals(HttpStatus.NOT_FOUND, response.getStatusCode());
